...
class EventClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->expectException(ActionMLAPIError::class);
    ...
    /**
     * @expectedException \actionml\ActionMLAPIError
     */
    ...
    public function testSetItem()
    {
        ...
        $this->assertEquals('book', $body['properties']['type'][0]);
        $this->assertNotNull($body['eventTime']);
        $this->assertEquals('POST', $request->getMethod());
        $this->assertEquals('http://localhost:9090/engines/test_ur/events', $request->getUri());
    }
    ...
    public function testRecordAction()
    {
        ...
        $this->assertEquals('2', $body['properties']['count'][0]);
        $this->assertNotNull($body['eventTime']);
        $this->assertEquals('POST', $request->getMethod());
        $this->assertEquals('http://localhost:9090/engines/test_ur/events', $request->getUri());
    }
